...
#!/usr/bin/env python3
# bot.py v2.0.0 (11.03.2026)
# - Исправлен импорт choose_plan
# - Актуализированы версии файлов и лог запуска
...
from handlers import (
    # Старт и меню
    start, role_chosen, main_menu, help_command, profile, choose_plan,
    # Фильтры
