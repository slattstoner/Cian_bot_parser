...
# ПОЛНЫЙ СПИСОК ЛИНИЙ МЕТРО МОСКВЫ (2026) – взят из исходного кода
METRO_LINES: Dict[str, Dict[str, Any]] = {
    '1': {'name': 'Сокольническая линия', 'stations': [
    ...
    '2': {'name': 'Замоскворецкая линия', 'stations': [
    ...
    '3': {'name': 'Арбатско-Покровская линия', 'stations': [
    ...
    '4': {'name': 'Филёвская линия', 'stations': [
    ...
    '5': {'name': 'Кольцевая линия', 'stations': [
    ...
    '6': {'name': 'Калужско-Рижская линия', 'stations': [
    ...
    '7': {'name': 'Таганско-Краснопресненская линия', 'stations': [
    ...
    '9': {'name': 'Серпуховско-Тимирязевская линия', 'stations': [
    ...
    '10': {'name': 'Люблинско-Дмитровская линия', 'stations': [
    ...
    '11': {'name': 'Большая кольцевая линия', 'stations': [
    ...
    '12': {'name': 'Бутовская линия', 'stations': [
    ...
    '15': {'name': 'Некрасовская линия', 'stations': [
        'Нижегородская', 'Стахановская', 'Окская', 'Юго-Восточная', 'Косино',
        'Улица Дмитриевского', 'Лухмановская', 'Некрасовка'
    ]},
    '16': {'name': 'Троицкая линия', 'stations': [
        'ЗИЛ', 'Крымская', 'Академическая', 'Вавиловская', 'Новаторская', 'Университет Дружбы Народов',
        'Генерала Тюленева', 'Тюменская', 'Корниловская', 'Коммунарка', 'Сосенки',
        'Ракитки', 'Десна', 'Кедровая', 'Ватутинки', 'Троицк'
    ]}
}
